...
// Absent on machines without the key → release falls back to debug signing.
...
android {
    namespace = "io.github.juansesdev.billparty"
    ...
    defaultConfig {
        ...
        applicationId = "io.github.juansesdev.billparty"
